...
public class Identity {
	...
	private Identity(Metadata metadata, List<String> mnemonicCodes, String password) throws Exception {
	...
	public static Identity createIdentity(String name, String password, String passwordHit, String network, String segWit) throws Exception {
	...
	public static Identity recoverIdentity(String mnemonic, String name, String password, String passwordHit, String network, String segWit) throws Exception {
	...
	void removeWallet(String walletId) throws Exception {
	...
	public Wallet deriveWalletsByMnemonics(String chain, String password, List<String> mnemonics) throws Exception {
		Wallet wallet;
		switch (chain) {
		case ChainType.BITCOIN:
			wallet = deriveBitcoinWallet(mnemonics, password, this.getMetadata().getSegWit());
		...
		case ChainType.DASH:
			...
			break;
		default:
			throw new TokenException(String.format("Doesn't support deriving %s wallet", chain));
		}
		addWallet(wallet);
		return wallet;
	}

	private static Identity tryLoadFromFile() throws Exception {
